...
"""
Build script for Python distribution.

It is here just to test that brink is working and to trigger remote builds.
"""
...
SETUP['repository']['name'] = u'python-distribution'
SETUP['repository']['github'] = 'https://github.com/chevah/python-distribution'
